...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","OFFLINEMUSICROBOT")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/RAJA-BABY/MUSICBOT",
)
...
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", 10000))
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/9596c89031e20bfabc524-c4b652d326c7231226.jpg"
)
PING_IMG_URL = getenv(
